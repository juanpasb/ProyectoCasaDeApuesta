	...
	public PanelReportes2() {
		...
		btnLista3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				apuestas.addElement(""); /* A�adir archivo ordenado como: Detalle de apuestas realizadas por cliente y sede por fecha discriminada por d�a y/o por
				mes y/o por a�o.*/
			}
		});
		...
		btnLista4.addActionListener(new ActionListener() {
			...
			total.addElement(""); /* A�adir archivo ordenado como: Total, de apuestas por sede, y tipo de juego por fecha discriminada por d�a y/o por mes
			y/o por a�o.*/
			}
		});
		...
		btnSig.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				PanelGraficos pgraf = new PanelGraficos();
				pgraf.setVisible(true);
				}
		});
