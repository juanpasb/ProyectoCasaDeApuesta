...
public class PanelReportes extends JFrame {
	...
	public PanelReportes() {
		...
		btnLista1.addActionListener(new ActionListener() {
			...
			clientes.addElement(""); //A�adir archivo ordenado como: Listado de clientes por sede por fecha discriminada por d�a y/o por mes y/o por a�o.
			}
		});
		...
		btnLista2.addActionListener(new ActionListener() {
			...
			totalAp.addElement(""); /*A�adir archivo ordenado como: Valor total de apuestas por cliente por fecha discriminada por d�a y/o por mes y/o por
			a�o.*/
			}
		});
