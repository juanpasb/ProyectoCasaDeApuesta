	...
	public PanelGraficos() {
		...
		btnLista1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ventas.addElement(""); // A�adir archivo ordenado como: Hist�rico de ventas de los �ltimos 5 d�as por sede.
			}
		});
		...
		btnTopSedes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				topSedes.addElement(""); // A�adir archivo ordenado como: Top 5 de las sedes con mayores ventas realizadas
			}
		});
		...
		btnTopC.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				topClientes.addElement(""); // A�adir archivo ordenado como: Top 5 de los clientes con mayores apuestas ganadas
			}
		});
		...
		btnTopAp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				topAp.addElement(""); // A�adir archivo ordenado como: Top 3 de los tipos de apuesta con mayores ganadores
			}
		});
